...
def pysp_instance_creation_callback(scenario_name, node_names):
    ...
    if scenario_name.startswith("u0"):
        ...
        model.SecondStageCost.expr = (model.xu0 - 1) 
        ...
        if scenario_name == "u00":
            ...
            model.ThirdStageCost.expr = (model.yu00 + 1) 
        elif scenario_name == "u01":
            model.yu01 = aml.Var()
            model.c.add(model.yu01 == model.y0)
            model.ThirdStageCost.expr = (2*model.yu01 - 3)  + 1
        else:
            assert False
        ...
        model.SecondStageCost.expr = (model.xu1 + 1) 
        ...
        if scenario_name == "u10":
            ...
            model.ThirdStageCost.expr = (0.5*model.yu10 - 1)  - 1
        elif scenario_name == "u11":
            model.yu11 = aml.Var()
            model.c.add(model.yu11 == model.y1)
            model.ThirdStageCost.expr = (0.2*model.yu11) 
        else:
            assert False
        ...
        model.SecondStageCost.expr = (model.xu2 - 0.5) 
        ...
        if scenario_name == "u20":
            ...
            model.ThirdStageCost.expr = (0.1*model.yu20 - 3)  + 2
        else:
            assert False
    else:
        assert False
